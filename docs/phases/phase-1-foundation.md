...
- **RFID2 (WS1850S) is untested** — no unit was connected during HY2.0 port bring-up.
- **RF433 GPIO pins are genuinely unknown** — left as an explicit, guarded `-1` TODO rather than a guessed value.
